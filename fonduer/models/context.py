...
FLT_ARRAY_TYPE = postgresql.ARRAY(Float)
...
class Section(Context):
    ...
    document = relationship(
        'Document',
        backref=backref(
            'sections', order_by=position, cascade='all, delete-orphan'),
        foreign_keys=document_id)
    para = relationship(
        'Para',
        backref=backref(
            'sections', order_by=position, cascade='all, delete-orphan'),
        foreign_keys=para_id)
    ...
    def __repr__(self):
        return "Section(Doc: %s, Position: %s)" % (
            self.document.name.encode('utf-8'), self.position)
...
class Header(Context):
    ...
    document = relationship(
        'Document',
        backref=backref(
            'headers', order_by=position, cascade='all, delete-orphan'),
        foreign_keys=document_id)
    para = relationship(
        'Para',
        backref=backref(
    ...
    def __repr__(self):
        return "Header(Doc: %s, Position: %s)" % (
            self.document.name.encode('utf-8'), self.position)
...
class FigureCaption(Context):
    ...
    document = relationship(
        'Document',
        backref=backref(
            'figCaptions', order_by=position, cascade='all, delete-orphan'),
        foreign_keys=document_id)
    para = relationship(
        'Para',
        backref=backref(
    ...
    def __repr__(self):
        return "FigureCaption(Doc: %s, Position: %s)" % (
            self.document.name.encode('utf-8'), self.position)
...
class TableCaption(Context):
    ...
    document = relationship(
        'Document',
        backref=backref(
            'tabCaptions', order_by=position, cascade='all, delete-orphan'),
        foreign_keys=document_id)
    para = relationship(
        'Para',
        backref=backref(
    ...
    def __repr__(self):
        return "TableCaption(Doc: %s, Position: %s)" % (
            self.document.name.encode('utf-8'), self.position)
...
class RefList(Context):
    ...
    document = relationship(
        'Document',
        backref=backref(
            'refLists', order_by=position, cascade='all, delete-orphan'),
        foreign_keys=document_id)
    para = relationship(
        'Para',
        backref=backref(
    ...
    def __repr__(self):
        return "RefList(Doc: %s, Position: %s)" % (
            self.document.name.encode('utf-8'), self.position)
...
class Para(Context):
    ...
    document = relationship(
        'Document',
        backref=backref(
            'paras', order_by=position, cascade='all, delete-orphan'),
        foreign_keys=document_id)
