...
setup(
    ...
    install_requires=[
        ...
        "torch>=0.4.1, <0.5.0;python_version<'3.7';sys_platform='linux'",
        "torch>=0.4.1, <0.5.0;sys_platform='darwin'",
        "torch>=0.4.1.post2, <0.5.0;python_version>='3.7';sys_platform='linux'",
        "tqdm>=4.26.0, <5.0.0",
